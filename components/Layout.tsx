        ...
        <div className="p-4 border-t border-borderColor mt-auto bg-surface/50">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="px-3 py-2 rounded-lg text-xs font-medium text-primary hover:bg-primary/10 transition-colors border border-transparent hover:border-primary/20 flex items-center justify-center gap-1"
