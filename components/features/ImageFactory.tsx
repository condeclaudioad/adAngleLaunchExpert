...
export const ImageFactory: React.FC = () => {
    ...
    const submitEdit = async () => {
        ...
        try {
            ...
            alert("Error al editar imagen: Verifique su API Key de Google.");
        } finally {
            setIsProcessing(false);
        }
    };
        ...
        <div className="max-w-7xl mx-auto pb-20 space-y-8 animate-fade-in relative">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-textMuted text-sm">Hiper-realismo + Identity Injection (Gemini 3 Pro + Grok Variaciones)</p>
                </div>
                <div className="flex gap-2">
            ...
            <Card className="flex flex-col md:flex-row gap-6 justify-between items-end !p-4 bg-surface/50">
                <div className="flex-1 w-full space-y-2">
                    ...
                    <div className="text-xs text-textMuted bg-surfaceHighlight/50 p-2 rounded">
                        Using secure environment keys (Google + Grok)
                    </div>
                </div>
            ...
            <div className="flex gap-6 border-b border-white/5">
                ...
                >
                    Variaciones (Grok) ({generatedImages.filter(i => i.type === 'variation').length})
                </button>
            </div>
